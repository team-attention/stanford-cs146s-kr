    ...
    assignments: [
      {
        ...
        krSlug: 'week-1-llm-prompting-playground',
      },
    ],
    lectures: [
      {
        ...
        krSlidesSlug: 'week-1-lecture-월-9-22',
      },
      {
        day: '2차시',
        ...
        krSlidesSlug: 'week-1-lecture-금-9-26',
      },
    ],
  },
  {
    ...
    assignments: [
      {
        ...
        krSlug: 'week-2-first-steps-in-the-ai-ide',
      },
    ],
    lectures: [
      {
        ...
        krSlidesSlug: 'week-2-lecture-월-9-29',
        additionalResources: [
          {
      ...
      },
      {
        ...
        krSlidesSlug: 'week-2-lecture-금-10-3',
        additionalResources: [
          {
            title: 'Completed Exercise',
  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        krSlug: 'week-3-getting-ai-to-work-in-complex-codebases',
      },
      {
        title: 'How FAANG Vibe Codes',
        url: 'https://x.com/rohanpaul_ai/status/1959414096589422619',
        krSlug: 'week-3-how-faang-vibe-codes',
      },
      {
        title: 'Writing Effective Tools for Agents',
        url: 'https://www.anthropic.com/engineering/writing-tools-for-agents',
        krSlug: 'week-3-writing-effective-tools-for-agents',
      },
    ],
    assignments: [
      {
        ...
        krSlug: 'week-3-build-a-custom-mcp-server',
      },
    ],
    lectures: [
      {
        ...
        krSlidesSlug: 'week-3-lecture-월-10-6',
        additionalResources: [
          {
      ...
      },
      {
        ...
        krSlidesSlug: 'week-3-lecture-금-10-10',
        guest: {
          name: 'Silas Alberti',
  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        krSlug: 'week-4-peeking-under-the-hood-of-claude-code',
      },
    ],
    assignments: [
      {
        ...
        krSlug: 'week-4-coding-with-claude-code',
      },
    ],
    lectures: [
      {
  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        krSlug: 'week-5-how-warp-uses-warp-to-build-warp',
      },
    ],
    assignments: [
      {
        ...
        krSlug: 'week-5-agentic-development-with-warp',
      },
    ],
    lectures: [
      {
  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        krSlug: 'week-6-copilot-remote-code-execution-via-prompt-injection',
      },
      {
        ...
        krSlug: 'week-6-finding-vulnerabilities-in-modern-web-apps-using-claude-code-and-openai-codex',
      },
      {
        ...
        krSlug: 'week-6-agentic-ai-threats-identity-spoofing-and-impersonation-risks',
      },
      {
        title: 'OWASP Top Ten: The Leading Web Application Security Risks',
        url: 'https://owasp.org/www-project-top-ten/',
        krSlug: 'week-6-owasp-top-ten-the-leading-web-application-security-risks',
      },
      {
        title: 'Context Rot: Understanding Degradation in AI Context Windows',
        url: 'https://research.trychroma.com/context-rot',
        krSlug: 'week-6-context-rot-understanding-degradation-in-ai-context-windows',
      },
      {
        ...
        krSlug: 'week-6-vulnerability-prompt-analysis-with-o3',
      },
    ],
    assignments: [
      {
        ...
        krSlug: 'week-6-writing-secure-ai-code',
      },
    ],
    lectures: [
      {
        ...
        krSlidesSlug: 'week-6-lecture-월-10-27',
      },
      {
        day: '2차시',
        title: '',
        krSlidesSlug: 'week-6-lecture-금-10-31',
        guest: {
          name: 'Isaac Evans',
          role: 'CEO',
          company: 'Semgrep',
    ...
    readings: [
      {
        ...
        krSlug: 'week-7-code-reviews-just-do-it',
      },
      {
        ...
        krSlug: 'week-7-how-to-review-code-effectively',
      },
      {
        title: 'AI-Assisted Assessment of Coding Practices in Modern Code Review',
        url: 'https://arxiv.org/pdf/2405.13565',
        krSlug: 'week-7-ai-assisted-assessment-of-coding-practices-in-modern-code-review',
      },
      {
        ...
        krSlug: 'week-7-ai-code-review-implementation-best-practices',
      },
      {
        ...
        krSlug: 'week-7-code-review-essentials-for-software-teams',
      },
      {
        title: 'Lessons from millions of AI code reviews',
        url: 'https://www.youtube.com/watch?v=TswQeKftnaw',
        krSlug: 'week-7-lessons-from-millions-of-ai-code-reviews',
      },
    ],
    assignments: [
      {
        ...
        krSlug: 'week-7-code-review-reps',
      },
    ],
    lectures: [
      {
    ...
    assignments: [
      {
        ...
        krSlug: 'week-8-multi-stack-web-app-builds',
      },
    ],
    lectures: [
      {
  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        krSlug: 'week-9-role-of-multi-agent-systems-in-making-software-engineers-ai-native',
      },
      {
        title: 'Benefits of Agentic AI in On-call Engineering',
        url: 'https://resolve.ai/blog/Top-5-Benefits',
        krSlug: 'week-9-benefits-of-agentic-ai-in-on-call-engineering',
      },
    ],
    assignments: [],
    lectures: [
