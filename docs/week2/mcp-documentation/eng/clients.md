...
parent_title: "Model Context Protocol Documentation"
parent_slug: "mcp-documentation"
...
[원본 링크](https://modelcontextprotocol.io/docs/learn/client-concepts) | [← 목록으로](./_index.md)
...
**Elicitation flow:** The flow enables dynamic information gathering. Servers can request specific data when needed, users provide information through appropriate UI, and servers continue processing with the newly acquired context.
...
**Sampling flow:** The flow ensures security through multiple human-in-the-loop checkpoints. Users review and can modify both the initial request and the generated response before it returns to the server.
