...
[원본 링크](https://modelcontextprotocol.io/docs/develop/connect-local-servers) | [← 목록으로](./_index.md)
...
- **Explore other servers** - Browse our collection of official and community-created MCP servers for additional capabilities: https://github.com/modelcontextprotocol/servers
- **Build your own server** - Create custom MCP servers tailored to your specific workflows and integrations: [/docs/develop/build-server](/docs/develop/build-server)
- **Connect to remote servers** - Learn how to connect Claude to remote MCP servers for cloud-based tools and services: [/docs/develop/connect-remote-servers](/docs/develop/connect-remote-servers)
- **Understand the protocol** - Dive deeper into how MCP works and its architecture: [/docs/learn/architecture](/docs/learn/architecture)
