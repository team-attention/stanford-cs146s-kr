...
'week4/how-anthropic-uses-claude-code': {
  ...
  'week5/warp-university': {
    slug: 'warp-university',
    week: 5,
    title: 'Warp University',
    titleKr: 'Warp University',
    author: 'Warp',
    readTime: '약 2시간',
    sourceUrl: 'https://www.warp.dev/university',
    sourceTitle: 'Warp University - AI-Powered Terminal Education',
    published: true,
    isParent: true,
    contentType: 'youtube',
    totalChapters: 41,
    categories: [
      { id: 'getting-started', title: 'Getting Started', titleKr: '시작하기' },
      { id: 'warp-code', title: 'Warp Code', titleKr: 'Warp Code' },
      { id: 'developer-workflows', title: 'Developer Workflows', titleKr: '개발자 워크플로우' },
      { id: 'using-mcp', title: 'Using MCP', titleKr: 'MCP 사용하기' },
      { id: 'rules', title: 'Rules', titleKr: '규칙' },
      { id: 'prompts', title: 'Prompts', titleKr: '프롬프트' },
      { id: 'how-warp-uses-warp', title: 'How Warp Uses Warp', titleKr: 'Warp의 자체 활용' },
    ],
    sections: [
      {
        title: '개요',
        content:
          'Warp University는 AI 기반 터미널 Warp의 공식 교육 콘텐츠입니다. 터미널 기본 사용법부터 AI 에이전트 활용, MCP 연동까지 다양한 주제를 다룹니다. 총 41개의 영상이 7개 카테고리로 구성되어 있습니다.',
      },
    ],
    keyTakeaways: [
      {
        title: '핵심 학습 목표',
        content:
          'Warp 터미널의 AI 기능을 활용하여 개발 생산성을 높이는 방법을 배웁니다. Rules, Prompts, MCP 서버를 통한 워크플로우 자동화를 익힙니다.',
      },
    ],
    children: [
      // Getting Started (9개)
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "프로젝트 규칙 파일",
                        "content": "Warp의 `warp.md` 파일은 LLM에게 프로젝트 컨텍스트를 제공하여 환각을 줄이고 일관성을 유지"
                },
                {
                        "title": "시작 방법",
                        "content": "`/init` 명령으로 프로젝트 루트에 `warp.md` 생성"
                },
                {
                        "title": "파일 구성",
                        "content": "일반 명령어, 아키텍처 개요, 프로젝트 구조를 표준 마크다운으로 문서화"
                },
                {
                        "title": "**모범 사례**:",
                        "content": ""
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "Warp CLI 소프트 런칭",
                        "content": "Warp의 에이전트를 어떤 환경에서도 사용할 수 있게 해주는 CLI 도구"
                },
                {
                        "title": "**세 가지 활용 사례**:",
                        "content": ""
                ...
                {
                        "title": "현재 상태",
                        "content": "베타 단계, 소규모 테스터 모집 중"
                }
        ],
      },
      {
        slug: 'minimal-ui',
        title: "Make Warp's UI More Minimal",
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "테마 커스터마이징",
                        "content": "Command P → \"themes\" 입력으로 테마 선택기 열기"
                },
                {
                        "title": "입력창 위치 설정",
                        "content": "세 가지 모드 - 상단에서 시작, 하단 고정, 상단 고정"
                },
                {
                        "title": "AI 설정",
                        "content": "AI 기능 제어, 에이전트 자율성 수준 설정, 모델 선택(기본: Claude Sonnet)"
                },
                {
                        "title": "권한 설정",
                        "content": "코드 diff, 파일 읽기, 계획, 명령 실행에 대한 권한 레벨 조정 가능"
                },
                {
                        "title": "코드베이스 인덱싱",
                        "content": "코딩 시 Warp를 최대한 활용하기 위한 필수 설정"
                },
                {
                        "title": "Warp Drive",
                        "content": "팀과 프롬프트, 명령어, 노트북, 환경 변수 공유 가능"
                },
                {
                        "title": "외관 설정",
                        "content": "폰트, 앱 아이콘 등 다양한 시각적 요소 커스터마이징"
                },
                {
                        "title": "키 바인딩",
                        "content": "Vim 모드를 포함한 키 바인딩 커스터마이징 가능"
                }
        ],
      },
      {
        slug: 'start-coding-task',
        ...
        keyTakeaways: [
                {
                        "title": "Warp를 사용해 Warp의 버그를 고치는 실제 워크플로우 시연",
                        "content": ""
                },
                {
                        "title": "음성 입력 기능으로 긴 프롬프트를 빠르게 작성 가능",
                        "content": ""
                },
                {
                        "title": "이미지 첨부, 파일 참조, URL 추가 등 다양한 컨텍스트 제공 방법",
                        "content": ""
                },
                {
                        "title": "Warp는 코드베이스 자동 인덱싱으로 관련 파일을 스마트하게 검색",
                        "content": ""
                },
                {
                        "title": "실용적 예시: \"프롬프트에 모델 선택기 표시\" 설정 버그 수정",
                        "content": ""
                }
        ],
      },
      {
        slug: 'edit-ai-code-inline',
        ...
        keyTakeaways: [
                {
                        "title": "Warp 에이전트는 프롬프트를 기반으로 자동으로 버그를 수정하고 작업 목록을 생성",
                        "content": ""
                },
                {
                        "title": "diff 뷰에서 변경사항을 미리 확인하고, 승인하거나 refine 또는 직접 편집 가능",
                        "content": ""
                },
                {
                        "title": "내장 코드 에디터를 통해 AI가 생성한 코드를 인라인으로 수정",
                        "content": ""
                },
                {
                        "title": "에이전트별 또는 전역 설정을 통해 자율성 수준 제어 가능",
                        "content": ""
                },
                {
                        "title": "grep, 코드베이스 임베딩 등 다양한 검색 도구를 활용하여 관련 파일 탐색",
                        "content": ""
                },
                {
                        "title": "변경사항 적용 후 자동으로 컴파일 및 검증 수행",
                        "content": ""
                },
                {
                        "title": "프롬프트만으로 버그를 완전히 수정하고 빌드 및 git 상태까지 관리",
                        "content": ""
                }
        ],
      },
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "파일 검색",
                        "content": "Command/Ctrl+O로 빠르게 파일 검색 및 이동"
                },
                {
                        "title": "탭 뷰어",
                        "content": "화면을 효율적으로 사용하는 탭 방식 파일 관리"
                },
                {
                        "title": "완전한 편집기",
                        "content": "Vim 없이도 사용 가능한 현대적 코드 편집 기능"
                },
                {
                        "title": "찾기/바꾸기",
                        "content": "정규표현식, 멀티커서, 대소문자 보존 지원"
                },
                {
                        "title": "구문 강조",
                        "content": "다양한 언어 지원으로 코드 가독성 향상"
                },
                {
                        "title": "파일 링크",
                        "content": "에이전트가 참조한 코드 라인으로 즉시 이동"
                },
                {
                        "title": "코드 리뷰 패널",
                        "content": "에이전트 변경사항을 한눈에 검토"
                },
                {
                        "title": "스니펫 참조",
                        "content": "필요한 코드만 컨텍스트로 전달하여 효율성 향상"
                },
                {
                        "title": "코드베이스 인덱싱",
                        "content": "자동 인덱싱으로 대규모 프로젝트 빠른 처리"
                },
                {
                        "title": "파일 트리 뷰",
                        "content": "리포지토리 전체를 시각적으로 탐색"
                }
        ],
      },
      // Developer Workflows (7개)
      {
        ...
        keyTakeaways: [
                {
                        "title": "Warp가 원격 Figma MCP 서버 지원을 출시하여 로컬 프로세스 관리가 불필요함",
                        "content": ""
                },
                {
                        "title": "OAuth 로그인으로 간단한 JSON 붙여넣기만으로 설정 완료 (토큰 관리 불필요)",
                        "content": ""
                },
                {
                        "title": "Figma MCP 서버는 AI 도구가 Figma 파일에서 직접 컨텍스트를 가져와 LLM 환각 감소",
                        "content": ""
                },
                {
                        "title": "스크린샷, 디자인 시스템 규칙, 코드, 메타데이터를 AI에 제공하여 정확한 코드 생성",
                        "content": ""
                },
                {
                        "title": "Figma 파일 링크를 복사하여 Warp 프롬프트에 붙여넣기만 하면 웹사이트 생성 가능",
                        "content": ""
                },
                {
                        "title": "Warp의 지속적인 입력 기능으로 작업 중간에도 피드백 반영 가능",
                        "content": ""
                },
                {
                        "title": "Sentry, GitHub, Linear 등 다른 MCP 서버도 동일한 방식으로 쉽게 설정 가능",
                        "content": ""
                }
        ],
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "Ollama",
                        "content": "로컬에서 AI 모델을 실행할 수 있는 무료 커맨드 라인 도구"
                },
                {
                        "title": "시스템 요구사항",
                ...
                {
                        "title": "애플리케이션 통합",
                        "content": "OpenAI 호환 엔드포인트 사용, base URL만 변경하면 됨"
                },
                {
                        "title": "모델 커스터마이징",
                        "content": "Modelfile로 system prompt, temperature 등 조정 가능"
                },
                {
                        "title": "Warp 활용",
                        "content": "AI 기반 명령어 검색, 모델 파일 생성 등 생산성 향상"
                }
        ],
      },
      {
        slug: 'understand-codebases',
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "Warp의 숨겨진 AI 기능",
                        "content": "Command + I로 REPL 내에서 AI 입력 생성 사용 가능"
                },
                {
                        "title": "자연어 → SQL 변환",
                        "content": "영어로 요청하면 현재 REPL 언어(Postgres, Node, Python 등)로 자동 번역"
                },
                {
                        "title": "컨텍스트 학습",
                        "content": "AI가 REPL 출력 데이터와 구조를 학습하여 점점 더 정확한 쿼리 생성"
                },
                {
                        "title": "복잡한 쿼리 생성",
                        "content": "다중 조건 쿼리도 자연어로 요청 가능 (예: 90일 내 가입, 특정 이메일 도메인, 팀 크기 조건)"
                },
                {
                        "title": "음성 입력 지원",
                        "content": "음성 단축키로 말하기만 해도 명령어 생성 가능"
                },
                {
                        "title": "범용성",
                        "content": "Postgres뿐만 아니라 Node, Python, GDB, MySQL 등 다양한 REPL에서 사용 가능"
                }
        ],
      },
      {
        slug: 'analyze-cloud-run-logs',
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "Warp의 멀티스레딩 기능으로 **여러 에이전트 탭에서 동시에 작업** 가능",
                        "content": ""
                },
                {
                        "title": "3가지 작업 동시 진행",
                        "content": "UI 코드 수정, PR 리뷰 현황 확인, 로그 분석"
                },
                {
                        "title": "음성 입력 지원",
                        "content": "긴 프롬프트를 타이핑 대신 말로 입력하여 효율성 증가"
                },
                {
                        "title": "MCP 통합",
                        "content": "Linear 이슈를 자동으로 읽어와 컨텍스트 파악"
                },
                {
                        "title": "저장된 프롬프트 재사용",
                        "content": "팀 전체에서 워크플로우 공유 가능"
                },
                {
                        "title": "실시간 작업 모니터링",
                        "content": "사이드 패널에서 모든 실행 중인 작업 한눈에 확인"
                },
                {
                        "title": "실용적인 사례",
                        "content": "포커스되지 않은 입력창의 배경 제거 기능을 자동으로 구현하고 즉시 테스트"
                }
        ],
      },
      // Using MCP (6개)
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "Context7 MCP",
                        "content": "웹의 최신 문서를 실시간으로 에이전트에 제공하는 MCP 서버"
                },
                {
                        "title": "자동 문서 참조",
                        "content": "`get library docs` 도구로 Astro 5 최신 문서 자동 조회"
                },
                {
                        "title": "레거시 프로젝트 현대화",
                        "content": "오래된 Astro 프로젝트를 최신 모범 사례로 일괄 업데이트"
                },
                {
                        "title": "시간 절약",
                        "content": "변경 로그 수동 검토 없이 자동으로 최신 표준 적용"
                },
                {
                        "title": "활용 사례",
                        "content": "프레임워크 마이그레이션, 오래된 프로젝트 리바이벌 시 유용"
                }
        ],
      },
      {
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "GitHub MCP 서버를 사용하면 Warp 에이전트가 GitHub 저장소와 직접 상호작용 가능",
                        "content": ""
                },
                {
                        "title": "설정에는 최소 권한의 GitHub 개인 액세스 토큰 필요 (repo + read user)",
                        "content": ""
                },
                {
                        "title": "실용적인 워크플로우 1: 모든 열린 PR의 논의 내용과 미해결 질문 자동 요약",
                        "content": ""
                },
                {
                        "title": "실용적인 워크플로우 2: 코드의 모든 to-do 주석을 자동으로 GitHub 이슈로 변환",
                        "content": ""
                },
                {
                        "title": "각 워크플로우당 20~30분의 시간 절약 효과",
                        "content": ""
                }
        ],
      },
      // Rules (5개)
      {
        ...
        sections: [
                {
                        "title": "전체 자막",
                        "content": "서로 연관된 프로젝트가 있고 그것들이 어디에 있는지 설명하세요. Warp에서는 세 개의 저장소가 서로 연관되어 있습니다. 서버 측 코드가 있는 Warp Server, 클라이언트 앱인 Warp Internal, 그리고 이들이 서로 통신할 때 사용하는 API 스키마를 저장하는 Warp Proto APIs가 있습니다. 이는 에이전트의 전역 규칙으로 설정하는 것이 가장 좋으며, 저는 Warp에서 이렇게 설정했습니다. 여기에 우리가 가진 세 개의 저장소와 저장소 간 스키마 업데이트 및 타입 업데이트 관행을 설명했습니다.\n\n이것은 앞으로 변경 사항을 만들 때 매우 유용합니다. 코딩 에이전트가 스키마를 업데이트하자마자, warp server로 CD하여 거기서 타입을 업데이트해야 한다는 것을 알게 됩니다. 그런 다음 클라이언트에서도 동일하게 수행합니다."
                }
        ],
        keyTakeaways: [
                {
                        "title": "모노레포 연결",
                        "content": "여러 연관된 저장소를 규칙으로 연결하여 에이전트가 프로젝트 간 관계를 이해하도록 설정"
                },
                {
                        "title": "Warp 사례",
                        "content": "서버(Warp Server), 클라이언트(Warp Internal), API 스키마(Warp Proto APIs) 세 저장소를 규칙으로 연결"
                },
                {
                        "title": "자동화 효과",
                        "content": "에이전트가 스키마를 업데이트하면 자동으로 관련 저장소로 이동하여 타입을 업데이트하는 워크플로우 실현"
                },
                {
                        "title": "전역 규칙 권장",
                        "content": "프로젝트 간 관계는 에이전트의 전역 규칙으로 설정하는 것이 효과적"
                }
        ],
      },
      {
        slug: 'rules-best-practices',
        title: 'Set Coding Best Practices with Rules',
        titleKr: '규칙으로 코딩 모범 사례 설정하기',
        category: 'rules',
        ...
        keyTakeaways: [
                {
                        "title": "코드 작성 규칙",
                        "content": "에이전트에게 코드 형식 지정과 작업 검증을 지시"
                },
                {
                        "title": "개인 선호사항 명시",
                        "content": "TypeScript에서 타입 vs 인터페이스 등 구체적 선호사항 전달"
                },
                {
                        "title": "오류 사전 방지",
                        "content": "솔루션 반환 전에 에이전트가 스스로 오류 검출"
                },
                {
                        "title": "헤밍웨이 테스트",
                        "content": "간결하고 읽기 쉬운 코드 주석 작성을 위한 원칙"
                },
                {
                        "title": "JS docs 품질",
                        "content": "명확하고 읽기 좋은 문서화 유지"
                }
        ],
      },
      {
        slug: 'rules-tech-stack',
        title: 'Set Tech Stack Preferences with Rules',
        titleKr: '규칙으로 기술 스택 선호도 설정하기',
        category: 'rules',
        sourceUrl: 'https://youtu.be/W5B6MhZsZ_4',
        published: true,
        hasMarkdown: true,
        readTime: '약 1분',
        sections: [
                {
                        "title": "전체 자막",
                        "content": "당신이 사용하고 싶은 기술을 적어두세요. 웹 앱을 만들어달라고 요청할 수는 있지만, 에이전트는 5년 전의 React와 Express 관행을 사용할 것입니다. 저는 웹사이트에는 Astro를 사용하고 데스크톱 앱에는 SvelteKit을 사용한다고 말하고 싶습니다. 그러면 에이전트가 다음번에 프로젝트를 구축할 때 그 선호도를 기억할 것입니다."
                }
        ],
        keyTakeaways: [
                {
                        "title": "AI 에이전트는 기본적으로 오래된 기술 스택과 관행을 사용할 수 있음",
                        "content": ""
                },
                {
                        "title": "규칙을 통해 선호하는 기술 스택을 명시적으로 지정해야 함",
                        "content": ""
                },
                {
                        "title": "예시: \"웹사이트는 Astro, 데스크톱 앱은 SvelteKit 사용\"",
                        "content": ""
                },
                {
                        "title": "에이전트는 한 번 설정한 기술 선호도를 기억하고 재사용함",
                        "content": ""
                },
                {
                        "title": "프로젝트 스캐폴딩 시 일관된 기술 스택 적용 가능",
                        "content": ""
                }
        ],
      },
      {
        slug: 'rules-coding-preferences',
        title: 'Set Coding Preferences with Rules',
        titleKr: '규칙으로 코딩 선호도 설정하기',
        category: 'rules',
        ...
        keyTakeaways: [
                {
                        "title": "Warp의 규칙 기능을 사용하여 AI 에이전트의 도구 선호도를 설정할 수 있음",
                        "content": ""
                },
                {
                        "title": "패키지 매니저 선호도 설정 예시: npm 대신 PNPM 사용",
                        "content": ""
                },
                {
                        "title": "Python 환경 설정 예시: Miniconda를 기본값으로 지정",
                        "content": ""
                },
                {
                        "title": "데스크톱 앱 개발 환경 설정 예시: Tauri CLI 우선 사용",
                        "content": ""
                },
                {
                        "title": "프로젝트별 환경 도구를 명시하면 AI가 일관된 개발 환경을 유지함",
                        "content": ""
                }
        ],
      },
      {
        slug: 'rules-prevent-secrets',
        title: 'Prevent Secrets from Leaking with Rules',
        titleKr: '규칙으로 비밀 유출 방지하기',
        category: 'rules',
        sourceUrl: 'https://youtu.be/2ECPFKtQpVk',
        published: true,
        hasMarkdown: true,
        readTime: '약 1분',
        sections: [],
        keyTakeaways: [
                {
                        "title": "에이전트에게 코드 블록이나 명령어 요청 시 비밀을 공유하지 않도록 규칙 설정",
                        "content": ""
                },
                {
                        "title": "페어 프로그래밍이나 라이브 스트리밍 시 특히 유용",
                        "content": ""
                },
                {
                        "title": "Warp의 비밀 삭제 기능을 활용하면 출력에서 비밀을 자동으로 숨김",
                        "content": ""
                },
                {
                        "title": "AI 에이전트가 민감한 정보를 보기 전에 사전 차단 가능",
                        "content": ""
                }
        ],
      },
      // Prompts (6개)
      {
        slug: 'prompts-debugging',
        title: 'Better Prompts for Debugging Your App',
        titleKr: '앱 디버깅을 위한 더 나은 프롬프트',
        category: 'prompts',
        ...
        sections: [
                {
                        "title": "전체 자막",
                        "content": "프로젝트를 위한 REST API를 만드는 것은 많은 오버헤드를 동반합니다. 테스트 스위트가 이러한 문제를 완화하는 데 도움이 되지만, 기존 방식대로 하면 평범한 결과만 얻게 됩니다. 여기, 여러분이 사용할 수 있는 더 나은 프롬프트가 있습니다. 이 프롬프트는 AI와 함께 앱을 개발하는 속도를 훨씬 빠르게 만들어줍니다. 이 프롬프트에서는 우리가 찾고자 하는 것을 명확하게 명시합니다. 유닛 테스트와 보안 테스트입니다. 이를 통해 변경사항을 커밋하거나 배포할 준비가 되면 간단한 명령어로 실행할 수 있는 테스트가 생성됩니다. 하지만 더 중요한 것은, 이 명령어를 rules 파일에 추가할 수 있다는 점입니다. 그러면 Warp가 이러한 테스트를 참조 기준(source of truth)으로 사용하여, Warp가 작성한 코드가 실제로 구현할 가치가 있는지 판단하게 됩니다."
                }
        ],
        keyTakeaways: [
                {
                        "title": "REST API 개발의 오버헤드를 줄이기 위한 효과적인 프롬프트 전략",
                        "content": ""
                },
                {
                        "title": "유닛 테스트와 보안 테스트를 명시적으로 요청하여 품질 향상",
                        "content": ""
                },
                {
                        "title": "생성된 테스트를 rules 파일에 추가하면 AI가 코드 품질을 자체 검증",
                        "content": ""
                },
                {
                        "title": "Warp가 테스트를 참조 기준으로 사용하여 구현 가치를 판단",
                        "content": ""
                }
        ],
      },
      {
        slug: 'prompts-db-optimization',
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "대규모 PR 리뷰 시 단순 요약은 위험 - 전체 그림을 놓칠 수 있음",
                        "content": ""
                },
                {
                        "title": "AI에게 인덱스와 우선순위 목록을 요청하여 효과적인 리뷰 경로 확보",
                        "content": ""
                },
                {
                        "title": "AI가 명백한 위험 신호를 먼저 잡아내게 하여 리뷰 효율 향상",
                        "content": ""
                },
                {
                        "title": "구조화된 출력으로 약한 모델에서도 일관된 결과 보장",
                        "content": ""
                },
                {
                        "title": "AI는 보조 도구일 뿐, 최종 검증은 개발자가 직접 수행해야 함",
                        "content": ""
                }
        ],
      },
      {
        slug: 'prompts-ui-mockup',
        title: 'How to Actually Code UI That Matches Your Mockup',
        titleKr: '목업과 일치하는 UI 실제로 코딩하기',
        category: 'prompts',
        ...
        sections: [
                {
                        "title": "전체 자막",
                        "content": "AI로 디자인을 작업할 때 흔히 겪는 문제가 있습니다. 보통 우리는 매우 구체적인 비전을 가지고 있습니다. 그런데 세부적으로 들어가려고 하면, 제대로 나오지 않습니다.\n\n우리처럼 디자인에도 시각적 이해가 필요합니다. 그래서 이를 위해 더 나은 프롬프트를 작성하는 방법이 있습니다. 이 방법은 전체 사양을 구조화된 마크다운 파일로 제공합니다. AI에게 UI 엔지니어라는 정체성을 부여한 점에 주목하세요.\n\n응답을 받으면 다른 프롬프트를 사용할 수 있습니다. 저는 React와 Tailwind를 사용하고 싶습니다.\n\n그러면 최종 구현에 더 가까운 결과를 얻게 됩니다. 중요한 점은 자신이 편한 기술 스택을 포함하고, 완성되면 작업을 확인하는 것입니다. 항상 완벽하지는 않겠지만, 이전보다 훨씬 더 가까워질 것입니다."
                }
        ],
        keyTakeaways: [
                {
                        "title": "문제",
                        "content": "AI는 구체적인 디자인 비전을 세부적으로 구현할 때 원하는 대로 나오지 않는 경우가 많음"
                },
                {
                        "title": "해결책",
                        "content": "AI에게 UI 엔지니어 역할을 부여하고 구조화된 마크다운으로 전체 사양을 먼저 작성하도록 요청"
                },
                {
                        "title": "2단계 프롬프트",
                        "content": "1) 사양 생성 → 2) 특정 기술 스택(React, Tailwind 등)으로 구현 요청"
                },
                {
                        "title": "핵심 팁",
                        "content": "자신이 익숙한 기술 스택을 명시하고, 완성 후 결과를 반드시 검증할 것"
                }
        ],
      },
      {
        slug: 'prompts-docker-setup',
        title: 'Create a Production Ready Docker Setup',
        titleKr: '프로덕션 레디 Docker 설정 만들기',
        category: 'prompts',
        ...
        keyTakeaways: [
                {
                        "title": "Warp는 프로젝트 전체를 분석하여 프로덕션 레디 Docker 설정을 자동 생성",
                        "content": ""
                },
                {
                        "title": "멀티 스테이지 구성과 최적화된 이미지 크기를 가진 Dockerfile 생성",
                        "content": ""
                },
                {
                        "title": ".dockerignore 파일로 불필요한 대용량 파일 제외",
                        "content": ""
                },
                {
                        "title": "docker-compose.yml로 개발/프로덕션 환경의 컨테이너 오케스트레이션",
                        "content": ""
                },
                {
                        "title": "수동 설정 시간을 크게 절약",
                        "content": ""
                }
        ],
      },
      {
        slug: 'prompts-saved-prompts',
        ...
        keyTakeaways: [
                {
                        "title": "저장된 프롬프트",
                        "content": "Warp의 프롬프트 기능을 사용하면 반복 작업을 자동화하고 팀과 공유할 수 있음"
                },
                {
                        "title": "Git 워크플로우 자동화",
                        "content": "커밋 생성, 코드 리뷰, PR 생성을 프롬프트로 실행 가능"
                },
                {
                        "title": "팀 협업",
                        "content": "Warp Drive를 통해 팀원 모두가 동일한 프롬프트를 사용할 수 있음"
                },
                {
                        "title": "빠른 실행",
                        "content": "`Command + P`로 커맨드 팔레트를 열어 프롬프트를 빠르게 검색 및 실행"
                },
                {
                        "title": "에이전트 모드 통합",
                        "content": "저장된 프롬프트는 Warp의 에이전트 모드와 결합하여 컨텍스트 인식 작업 수행"
                },
                {
                        "title": "코드 품질 개선",
                        "content": "푸시 전 코드 리뷰 프롬프트를 실행하여 버그를 조기에 발견할 수 있음"
                }
        ],
      },
      // How Warp Uses Warp (6개)
      {
        slug: 'warp-understand-codebase',
      ...
      },
      {
        ...
        keyTakeaways: [
                {
                        "title": "텍스트의 한계 극복",
                        "content": "UI 컴포넌트나 시각적 요소는 텍스트로 설명하기 어렵지만, 이미지로는 즉시 전달 가능"
                },
                {
                        "title": "\"백문이 불여일견\"의 실현",
                        "content": "AI 에이전트도 인간처럼 이미지를 통해 더 정확하게 이해"
                },
                {
                        "title": "작업",
                        "content": "MCP 마켓플레이스 UI를 Figma 목업에서 실제 코드로 구현"
                },
                {
                        "title": "프로세스",
                        "content": "Figma 스크린샷 → 에이전트 모드에 첨부 → 음성/텍스트로 지시 → 자동 코드 생성"
                },
                {
                        "title": "결과",
                        "content": "1-2일 걸릴 작업을 20분 만에 완료"
                },
                {
                        "title": "반복적 diff 적용",
                        "content": "AI는 큰 변경보다 작은 diff를 여러 번 적용하는 것이 더 효과적"
                },
                {
                        "title": "자동 승인 모드",
                        "content": "작업 초기에만 확인하고 나머지는 자동화 가능"
                },
                {
                        "title": "토큰 최적화",
                        "content": "클라이언트 측에서 이미지 크기를 지능적으로 조정하여 토큰 소비 최소화"
                },
                {
                        "title": "에이전트 상호작용 실패는 주로 \"시작 단계\"에서 발생 (잘못된 파일, 작업 오해 등)",
                        "content": ""
                },
                {
                        "title": "이미지 컨텍스트는 UI 작업에 특히 효과적 (픽셀 단위 설명 불필요)",
                        "content": ""
                },
                {
                        "title": "이 기능 자체도 Warp 에이전트로 개발됨 (dogfooding의 실례)",
                        "content": ""
                }
        ],
      },
      {
        slug: 'warp-multiple-agents',
        ...
        keyTakeaways: [
                {
                        "title": "병렬 작업 관리",
                        "content": "Warp의 에이전트는 여러 작업을 동시에 처리하며, 데스크톱 알림으로 상태를 실시간 알려줌"
                },
                {
                        "title": "음성 입력",
                        "content": "Whisper flow를 사용한 음성 모드로 타이핑 없이 자연스럽게 명령 입력"
                },
                {
                        "title": "컨텍스트 자동완성",
                        "content": "@ context를 사용하여 파일 경로와 디렉토리를 자동완성하여 효율적으로 작업"
                },
                {
                        "title": "블로킹 알림",
                        "content": "에이전트가 코드 리뷰 등으로 블로킹되면 토스트 알림과 키보드 단축키로 즉시 확인 가능"
                },
                {
                        "title": "자동 수락 모드",
                        "content": "코드 diff를 처음 검토 후 올바른 방향이면 fast forward로 자동 수락 활성화"
                },
                {
                        "title": "CLI 통합",
                        "content": "Warp는 cargo, git, gcloud 등 다양한 CLI를 인식하고 자동으로 적절한 명령어 선택"
                },
                {
                        "title": "워크플로우 최적화",
                        "content": "백로그 작업을 에이전트에 맡기고 중요한 제품 로드맵 작업에 집중 가능"
                }
        ],
      },
      {
        slug: 'warp-mcp-servers',
        ...
        keyTakeaways: [
                {
                        "title": "MCP 서버 통합",
                        "content": "Warp은 Linear와 같은 외부 서비스와 통합할 수 있는 MCP 서버를 지원합니다"
                },
                {
                        "title": "동적 컨텍스트",
                        "content": "대화 중간에 MCP 서버를 추가해도 즉시 다음 메시지부터 컨텍스트로 활용됩니다"
                },
                {
                        "title": "티켓 자동 해결",
                        "content": "Linear MCP 서버를 통해 AI가 티켓 정보를 자동으로 가져와 문제를 이해하고 해결책을 구현합니다"
                },
                {
                        "title": "최소한의 사용자 입력",
                        "content": "AI가 필요한 컨텍스트를 직접 수집하고 기존 코드를 참고하여 자동으로 작업을 완료합니다"
                }
        ],
      },
      {
        slug: 'warp-building-input',
        ...
        keyTakeaways: [
                {
                        "title": "유니버설 입력 재설계",
                        "content": "Warp의 제품 디자이너 Dave가 Warp AI를 사용해 Warp의 유니버설 입력 인터페이스를 재설계하고 구현한 사례"
                },
                {
                        "title": "디자이너의 코드 작업",
                        "content": "엔지니어링 리소스 부족으로 디자이너가 직접 Warp AI를 활용해 복잡한 코드베이스(Rust, 100만+ 줄)에서 작업"
                },
                {
                        "title": "실제 사례",
                        "content": "Git diff 칩의 폰트 크기를 1픽셀 줄이는 작업을 Warp AI로 수행"
                },
                {
                        "title": "디자이너-개발자 간극 해소",
                        "content": "AI 도구가 비개발자도 복잡한 코드베이스에서 작업 가능하게 함"
                },
                {
                        "title": "생산성 향상",
                        "content": "리소스 제약 상황에서도 제품 개선 지속 가능"
                },
                {
                        "title": "내부 도구 활용(Dogfooding)",
                        "content": "Warp가 자사 제품을 활용해 자사 제품을 개선하는 사례"
                }
        ],
      },
      {
        slug: 'warp-creating-rules',
