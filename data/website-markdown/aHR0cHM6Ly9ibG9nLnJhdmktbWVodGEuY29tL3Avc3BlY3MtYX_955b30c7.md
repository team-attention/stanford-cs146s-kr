...
Formatted At: 2026-01-04T05:31:29.697Z
-->
...
[Ravi Mehta](https://substack.com/@ravimehta) and [Danny Martinez](https://substack.com/@dannymartinez)  
Jul 31, 2025
...
> _We need a button in the header that directs to the company-apply page. I'm focused on the emails at the moment. This is vibe code-able if you can pick it up please._
...
1. Generate a Linear ticket out of the Slack message from my co-founder.
2. Clarify what I want the new copy to be in the ticket.
3. Open up Copilot and prompt Claude to open up the Linear ticket.
4. Prompt Claude to review the ticket and analyze it relative to the codebase.
5. Prompt Claude to create a branch and implement these changes.
6. Test the changes to ensure they’re working as expected.
7. Open a pull request (PR) on GitHub to ship these changes into the codebase.
8. Wait for an engineer to review/approve the PR.

![Spec-driven development process](https://substackcdn.com/image/fetch/$s_!xqds!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F297f8c19-63ff-481f-8c6b-6e894b9c52fc_997x628.png)
...
![AI and PMs](https://substackcdn.com/image/fetch/$s_!ZQkP!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F802f97db-32c9-4971-aa7a-0412c60ccd24_1600x1368.jpeg)
