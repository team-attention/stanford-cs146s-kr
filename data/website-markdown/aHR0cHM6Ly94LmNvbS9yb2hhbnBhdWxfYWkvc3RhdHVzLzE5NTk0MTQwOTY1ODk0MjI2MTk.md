...
**Author**: [@rohanpaul_ai](https://x.com/rohanpaul_ai)

> FAANG software engineer tells how they vibe code at FAANG

**Source**: [Reddit - r/vibecoding](https://reddit.com/r/vibecoding/comments/1myakhd/how_we_vibe_code_at_a_faang/)

---

## How we vibe code at a FAANG.

**Posted by**: u/TreeTopologyTroubado in r/vibecoding
...
6. **Code submission review.** We have a two dev approval process before code can get merged into main. AI is also showing great promise in assisting with the review.
...
Always start with a solid design doc and architecture. Build from there in chunks. Always write tests first.
